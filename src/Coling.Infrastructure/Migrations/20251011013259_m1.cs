    ...
    public partial class m1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkFieldCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Institutions_Parties_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    WorkFieldCategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkFields_WorkFieldCategories_WorkFieldCategoryId",
                        column: x => x.WorkFieldCategoryId,
                        principalTable: "WorkFieldCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IssuesCertificate = table.Column<bool>(type: "bit", nullable: false),
                    CertificateNumber = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContinuingEducations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ContinuingEducations_Educations_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThesisTitle = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    GPA = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    HasHonors = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DegreeEducations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DegreeEducations_Educations_Id",
                        column: x => x.Id,
                        principalTable: "Educations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProfessionalCertifications_Educations_Id",
                        column: x => x.Id,
                        principalTable: "Educations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TitleReceived = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    YearStarted = table.Column<int>(type: "int", nullable: true),
                    MonthStarted = table.Column<int>(type: "int", nullable: true),
                    DayStarted = table.Column<int>(type: "int", nullable: true),
                    YearCompleted = table.Column<int>(type: "int", nullable: true),
                    MonthCompleted = table.Column<int>(type: "int", nullable: true),
                    DayCompleted = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MemberEducations_Educations_EducationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkExperiences_Institutions_InstitutionId",
                        column: x => x.InstitutionId,
                        principalTable: "Institutions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkExperienceFields", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkExperienceFields_WorkExperiences_WorkExperienceId",
                        column: x => x.WorkExperienceId,
                        principalTable: "WorkExperiences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkExperienceFields_WorkFields_WorkFieldId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemberEducations_EducationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkExperienceFields_WorkExperienceId_WorkFieldId",
                table: "WorkExperienceFields",
                columns: new[] { "WorkExperienceId", "WorkFieldId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WorkExperienceFields_WorkFieldId",
                table: "WorkExperienceFields",
                column: "WorkFieldId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkExperiences_InstitutionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkFields_WorkFieldCategoryId",
                table: "WorkFields",
                column: "WorkFieldCategoryId");
        }
